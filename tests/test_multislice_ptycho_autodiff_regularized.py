...
def test_multislice_ptycho_autodiff_regularized(generate_gold=False, debug=False):
    name = 'test_multislice_ptycho_autodiff_regularized'
...
if __name__ == '__main__':
    ...
    test_multislice_ptycho_autodiff_regularized(generate_gold=args.generate_gold, debug=True)
