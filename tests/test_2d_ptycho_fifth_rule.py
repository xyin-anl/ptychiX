...
def test_2d_ptycho_fifth_rule(generate_gold=False, debug=False):
    name = 'test_2d_ptycho_fifth_rule'
    ...
    options.reconstructor_options.batch_size = 961
...
if __name__ == '__main__':
    ...
    test_2d_ptycho_fifth_rule(generate_gold=args.generate_gold, debug=True)
