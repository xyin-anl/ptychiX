...
def test_2d_ptycho_lsqml_momentum(pytestconfig, generate_gold=False, debug=False, high_tol=False):
...
if __name__ == '__main__':
    ...
    test_2d_ptycho_lsqml_momentum(None, generate_gold=args.generate_gold, debug=True, high_tol=args.high_tol)
